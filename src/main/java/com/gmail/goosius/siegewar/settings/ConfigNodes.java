...
public enum ConfigNodes {
	...
	SIEGE_MATERIAL_RESTRICTIONS_SIEGEZONE_BLOCK_PLACEMENT_PREVENTION_MATERIALS(
			"siege_material_restrictions.siegezone_block_placement_prevention_materials",
			"obsidian, ender_chest, white_bed, orange_bed, magenta_bed, light_blue_bed, yellow_bed, lime_bed, pink_bed, gray_bed, light_gray_bed, cyan_bed, purple_bed, blue_bed, brown_bed, green_bed, red_bed, black_bed, cobweb",
			"",
			"# This setting is similar to wilderness_block_placement_prevention_materials,",
			...
			"# Useful to block grief/escape blocks such as obsidian, ender chests, beds and cobwebs.",
			"# WARNING: Avoid putting 'common' blocks on this list as that may cause lag."),
	...
	PEACEFUL_TOWNS_CANNOT_ASSIGN_MILITARY_RANKS(
			...
			"# When true, military ranks are also stripped from any resident who joins a peaceful town.",
			"# It is not recommended to set this to false."),
	PEACEFUL_TOWNS_RESIDENTS_CANNOT_PARTICIPATE(
			"peaceful_towns.residents_cannot_participate_in_siegewar",
			"true",
			"",
			"# If true, residents of a peaceful town cannot participate in SiegeWar,",
			"# even if they hold a military rank or are a nation leader (king).",
			"# They count as non-participants: they cannot earn/lose battle points or control",
			"# siege banners, and they will receive siege sickness inside a siege zone.",
			"# This is useful when peaceful capitals are allowed: a king keeps their auto military",
			"# rank (to manage ranks in their non-peaceful towns) but cannot fight while peaceful."),
